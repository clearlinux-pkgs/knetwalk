...
Version  : 21.08.3
Release  : 33
URL      : https://download.kde.org/stable/release-service/21.08.3/src/knetwalk-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/knetwalk-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/knetwalk-21.08.3.tar.xz.sig
...
%prep
%setup -q -n knetwalk-21.08.3
cd %{_builddir}/knetwalk-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636058503
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knetwalk-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/knetwalk/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/knetwalk-21.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/knetwalk/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang knetwalk
